...
class Outcome extends Component {
    ...
    // const rowsForForegn = monitoringForegn.histories;
    render() {
        console.log("Outcome js ============>");
        let iterator = 0;
        const {classes, outcomeData, historyType, lastPage, currentLanguage} = this.props;
            ...
            >
                <DialogContent>
                    ...
                    <Grid container justify="center">
                        <Typography className={`${classes.checkPayment} check-payment`}>
